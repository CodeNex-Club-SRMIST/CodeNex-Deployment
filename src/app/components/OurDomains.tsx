...
const OurDomains: React.FC = () => {
  const domainData = [
    ...
    { title: "WebDevelopment", description: "ECrafting seamless digital experiences with scalable, responsive, and high-performance web solutions." },
    { title: "CyberSecurity", description: "Developing decentralized solutions for secure, transparent, and tamper-proof digital transactions." },
    { title: "BlockChain", description: "Developing decentralized solutions for secure, transparent, and tamper-proof digital transactions." },
    { title: "Creatives", description: "Blending design and innovation to craft visually compelling and engaging digital experiences." },
    { title: "Corporate", description: "Driving strategic growth through innovation, partnerships, and data-driven business solutions." },
  ];
