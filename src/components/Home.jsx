          ...
          <div className="pt-20 lg:pt-40 px-4 lg:pl-20 flex flex-col items-center lg:items-start">
            ...
            <div className="flex flex-col items-center lg:flex-row mt-5">
              ...
              <img
                src={lg2}
                alt=""
                className="w-[250px] md:w-[400px] lg:w-[550px] h-auto max-h-[100px] md:max-h-[125px] mb-4 lg:mb-0"
              />
              {/* Adjusted clb image for mobile */}
              <img
                src={clb}
                alt=""
                className="w-[150px] md:w-[220px] lg:w-[270px] h-auto max-h-[60px] md:max-h-[90px] mt-2 lg:mt-5"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-col lg:flex-row pb-10">
            <div className="flex-1">
              <p className="text-white font-semibold text-2xl md:text-3xl w-full mt-16">
                ...
                doloremque obcaecati quasi!
              </p>
              <p className="text-white font-semibold text-2xl md:text-3xl w-full mt-12">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut
                perferendis id qui quaerat libero dignissimos beatae iusto illo
                voluptatem voluptatum, reprehenderit numquam? Sit, inventore
                doloremque error harum voluptates tempora et ullam.
              </p>
