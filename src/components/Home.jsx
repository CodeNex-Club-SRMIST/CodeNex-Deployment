    ...
    <>
      <div className='bg-black'>
        ...
        <div className='px-6 sm:px-12 md:px-24'>
          <div>
            <p className='text-4xl font-extrabold p-8 text-white mt-16'>ABOUT US</p>
          </div>

          <div className='flex flex-col md:flex-row lg:flex-row items-center justify-between pb-10'>
